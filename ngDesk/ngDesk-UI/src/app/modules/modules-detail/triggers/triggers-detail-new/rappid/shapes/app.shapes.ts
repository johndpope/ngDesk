...
export enum ShapeTypesEnum {
	BASE = 'app.Base',
	SEND_EMAIL = 'app.SendEmail',
	START_ESCALATION = 'app.StartEscalation',
	FLOWCHART_START = 'app.FlowchartStart',
	FLOWCHART_END = 'app.FlowchartEnd',
	LINK = 'app.Link',
	MAKE_PHONE_CALL = 'app.MakePhoneCall',
	STOP_ESCALATION = 'app.StopEscalation',
	SEND_SMS = 'app.SendSms',
	CREATE_ENTRY = 'app.CreateEntry',
	UPDATE_ENTRY = 'app.UpdateEntry',
	DELETE_ENTRY = 'app.DeleteEntry',
	APPROVAL = 'app.Approval',
	GENERATE_PDF = 'app.GeneratePdf',
	TEAMS_ENTRY = 'app.MicrosoftTeamsNotification',
	SIGN_NODE = 'app.SignatureDocument',
}
...
const baseDefinitionForApproval = {
	size: { width: 368, height: 80 },
	ports: {
		groups: {
			in: {
		...
		items: [
			...
			{
				group: 'out',
				attrs: { portLabel: { text: 'Approve' } },
			},
			{
				group: 'out',
				attrs: { portLabel: { text: 'Reject' } },
			}
		],
	},
	attrs: {
...
const SendEmail = Base.define(
	ShapeTypesEnum.SEND_EMAIL,
	baseDefinition,
	additionalConfig
);

const StopEscalation = Base.define(
	ShapeTypesEnum.STOP_ESCALATION,
	baseDefinition,
	additionalConfig
);

const SendSms = Base.define(
	ShapeTypesEnum.SEND_SMS,
	baseDefinition,
	additionalConfig
);

const MakePhoneCall = Base.define(
	ShapeTypesEnum.MAKE_PHONE_CALL,
	baseDefinition,
	additionalConfig
);

const StartEscalation = Base.define(
	ShapeTypesEnum.START_ESCALATION,
	baseDefinition,
	additionalConfig
);

const CreateEntry = Base.define(
	ShapeTypesEnum.CREATE_ENTRY,
	baseDefinition,
	additionalConfig
);
const DeleteEntry = Base.define(
	ShapeTypesEnum.DELETE_ENTRY,
	baseDefinition,
	additionalConfig
);

const UpdateEntry = Base.define(
	ShapeTypesEnum.UPDATE_ENTRY,
	baseDefinition,
	additionalConfig
);

const Approval = Base.define(
	ShapeTypesEnum.APPROVAL,
	baseDefinitionForApproval,
	additionalConfig
);

const GeneratePdf = Base.define(
	ShapeTypesEnum.GENERATE_PDF,
	baseDefinition,
	additionalConfig
);

const MicrosoftTeamsNotification = Base.define(
	ShapeTypesEnum.TEAMS_ENTRY,
	baseDefinition,
	additionalConfig
);

const SignatureDocument = Base.define(
