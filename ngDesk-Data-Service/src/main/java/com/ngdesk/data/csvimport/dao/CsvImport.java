...
public class CsvImport {
	...
	@Schema(required = false, description = "Status of the csv file", example = "Failed")
	...
	@Schema(required = false, description = "Logs of csv file")
	private List<CsvImportLog> logs;

	@Schema(required = false, accessMode = AccessMode.READ_ONLY, description = "Autogenerated Id")
	private String companyId;

	@Schema(required = false, description = "CSV import name")
	private String name;
	...
	@Schema(required = false, description = "Count of complete csv")
	private int completedCount;

	@Schema(required = false, description = "Count of failed csv")
	private int failedCount;

	@Schema(required = false, description = "Date of csv creation")
	private Date dateCreated;

	@Schema(required = false, description = "Csv creator Id")
