...
public class Module {
	...
	public Module(String moduleId, String name, String parentModule, String description, String singular, String plural,
			List<ModuleValidation> validations, List<ModuleField> fields, List<ListLayout> listLayout,
			List<CreateEditLayout> createLayout, List<CreateEditLayout> editLayout,
			List<ListMobileLayout> listMobileLayouts, List<CreateEditMobileLayout> createMobileLayout,
			List<CreateEditMobileLayout> editMobileLayout, Date dateCreated, Date dateUpdated, String createdBy,
			String lastUpdatedBy, List<Workflow> workflows, List<String> alternatePrimaryKeys, List<Form> form) {
		super();
