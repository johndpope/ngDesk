...
public class Filter {
	...
	@Pattern(regexp = "CHANGED|EQUALS_TO|NOT_EQUALS_TO|CONTAINS|DOES_NOT_CONTAIN|REGEX|LESS_THAN|GREATER_THAN|LENGTH_GREATER_THAN|LENGTH_LESS_THAN|DAYS_BEFORE_TODAY", message = "NOT_VALID_OPERATOR")
	...
	public Filter(@NotNull(message = "FILTER_FIELD") @Valid ReportField field,
			@Pattern(regexp = "CHANGED|EQUALS_TO|NOT_EQUALS_TO|CONTAINS|DOES_NOT_CONTAIN|REGEX|LESS_THAN|GREATER_THAN|LENGTH_GREATER_THAN|LENGTH_LESS_THAN|DAYS_BEFORE_TODAY", message = "NOT_VALID_OPERATOR") String operator,
