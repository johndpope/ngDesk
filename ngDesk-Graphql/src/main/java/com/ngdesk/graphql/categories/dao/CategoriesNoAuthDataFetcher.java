...
@Component
public class CategoriesNoAuthDataFetcher implements DataFetcher<List<Category>> {
	...
	public List<Category> get(DataFetchingEnvironment environment) {
		...
		Optional<List<Category>> optionalCategories = categoryRepository.findCategoriesByPublicTeamId(publicTeamId,
				pageable, "categories_" + companyId);
