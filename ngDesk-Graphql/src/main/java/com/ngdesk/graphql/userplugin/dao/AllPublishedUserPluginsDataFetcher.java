...
@Component
public class AllPublishedUserPluginsDataFetcher implements DataFetcher<List<UserPlugin>> {

	@Autowired
	UserPluginRepository userPluginRepository;

	@Override
	public List<UserPlugin> get(DataFetchingEnvironment environment) {
		...
		Optional<List<UserPlugin>> optional = userPluginRepository.findAllPublishedUserPlugins(pageable,
				"user_plugins");
