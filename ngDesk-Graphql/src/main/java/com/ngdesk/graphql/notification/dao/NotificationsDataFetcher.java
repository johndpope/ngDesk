...
@Component
public class NotificationsDataFetcher implements DataFetcher<List<Notification>> {
	@Autowired
	...
	public List<Notification> get(DataFetchingEnvironment environment) {
		...
		Optional<List<Notification>> optionalNotifications = notificationRepository
				.findAllNotificationsInCompany(pageable, companyId, userId, "notifications");
