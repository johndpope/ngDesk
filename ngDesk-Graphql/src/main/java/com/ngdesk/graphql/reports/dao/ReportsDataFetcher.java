...
@Component
public class ReportsDataFetcher implements DataFetcher<List<Report>> {
	...
	@Override
	public List<Report> get(DataFetchingEnvironment environment) {
		...
		Optional<List<Report>> optional = reportRepository.findAllReportInCompany(pageable, "reports_" + companyId);
