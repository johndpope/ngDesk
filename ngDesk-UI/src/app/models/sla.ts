...
export class SlaBusinessRules {
  constructor(
    private HAS_RESTRICTIONS: boolean,
    private RESTRICTION_TYPE: string,
    private SLA_RESTRICTIONS: LayerRestriction[]
  ) {}

  public get hasRestriction() {
    return this.HAS_RESTRICTIONS;
  }

  public set hasRestriction(hasRestriction: boolean) {
    this.HAS_RESTRICTIONS = hasRestriction;
  }
  ...
  public get slaRestrictions() {
    return this.SLA_RESTRICTIONS;
  }

  public set slaRestrictions(slaRestrictions: LayerRestriction[]) {
    this.SLA_RESTRICTIONS = slaRestrictions;
  }
}
...
export class ModuleWorkflow {
  constructor(
    ...
    private BUSINESS_RULES: SlaBusinessRules,
  ...
  public set isRecurring(isRecurring: boolean) {
  ...
  public set intervalTime(intervalTime: number) {
    this.INTERVAL_TIME = intervalTime;
  }

  public get maxReccurence() {
    return this.MAX_RECCURENCE;
  }

  public set maxReccurence(maxReccurence: number) {
    this.MAX_RECCURENCE = maxReccurence;
  }
  ...
  public get slaBusinessRules() {
    return this.BUSINESS_RULES;
  }

  public set slaBusinessRules(slaBusinessRules: SlaBusinessRules) {
    this.BUSINESS_RULES = slaBusinessRules;
  }
}
